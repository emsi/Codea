-- Basically a movable triangle button

TriangleBlock = class(TriangleButton)

function TriangleBlock:touched(touch)
    ...
    elseif self.activeTouch==touch.id then -- the block was touched
       ...
       elseif touch.state==ENDED then -- the touch ended
            ...
            self.onTouchEnded(touch) -- process callback
        end 
    end
end
